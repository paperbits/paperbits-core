...
import { ComponentStyleDefinition, LocalStyles, PrimitiveContract, StyleDefinition } from "@paperbits/common/styles";
...
export class GridEditor {
    ...
    private getStylableGridItem(element: HTMLElement, binding: IWidgetBinding<any, any>): GridItem {
        ...
        const keyWithoutVariations = styleKeySegments.filter(segment => segment !== "default" && segment !== "instance").join("/");
        const styleDefinitions = handler.getStyleDefinitions();
        const componentStyleDefinition = Objects.getObjectAt<ComponentStyleDefinition>(keyWithoutVariations, styleDefinitions);
        ...
        const defaultCommand: IContextCommand = {
            ...
            callback: () => {
                ...
                let localStyles: LocalStyles;
                localStyles = Objects.getObjectAt(shortKey, styles);
                ...
                if (!localStyles) {
                    ...
                    Objects.setValue(shortKey, styles, localStyles);
                }
